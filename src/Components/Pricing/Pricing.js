...
function Pricing() {
  const features = [
    'Visite des lieux',
    'Rapport de visite avec analyse',
    'Analyse de l’état du bien et de ses qualités techniques',
    'Examen des possibilités d’adaptation à vos besoins, de transformation et d’agrandissement',
      ...
      <div className="bg-gradient-to-b from-blue-50 via-white to-white">
        ...
        <div className="max-w-7xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:px-8">
          <div className="pb-16 xl:flex xl:items-center xl:justify-between">
            <div>
              <h1 className="text-4xl font-extrabold sm:text-4xl sm:tracking-tight">
                <p className="text-gray-900">Un court dialogue vaut mieux qu'un</p>
                <p className="text-blue-600">long discours</p>
              </h1>
          ...
          <div className="border-t border-gray-200 pt-16 xl:grid xl:grid-cols-3 xl:gap-x-8">
            <div>
              <h2 className="text-base font-semibold text-blue-600 uppercase tracking-wide">bilan et conseil</h2>
              <p className="mt-2 text-3xl font-extrabold text-gray-900">Nos tarifs</p>
              <p className="mt-5 text-lg text-gray-500 max-w-xs">
              Sur la base de 200€ par heure, ils comprennent :
              </p>
            </div>
