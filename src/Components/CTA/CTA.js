      ...
      <div className="bg-blue-600 max-w-6xl mx-auto ">
        <div className="max-w-5xl mx-auto text-center py-16 px-4 sm:py-20 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-extrabold text-white sm:text-5xl">
            <span className="block">L'expertise d'une <span className="text-yellow-300">architecte</span></span>
            <span className="block">au service de votre <span className="text-yellow-300">projet immobilier </span></span>
          </h2>
          <p className="mt-4 text-lg leading-6 text-yellow-100">
            Avec plus de 30 ans d'expérince dans la conception et la rénovation de biens immobiliers, nous saurons vous accompagner dans 
